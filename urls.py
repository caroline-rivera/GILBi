...
urlpatterns = patterns('',
    ...
    url(r'^acervo/livros/pesquisar/$', 
        'apps.books.views.search_books'),
    ...
    url(r'^gerenciarlivraria/pedidodecompra/(?P<purchase_order_id>\d+)/excluir/$', 
        'apps.bookstore.views.purchase_order.exclude'),          
